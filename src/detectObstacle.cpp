...
using namespace cv;
using namespace std;
//0: hon da; 1:Bong cay; 2:1 thung; 3: 3thung
...
void DetectObstacle::trackObject1 (Mat threshold, Mat &src, ObstacleFeature &f)
{
    ...
    for (int i = 0; i < listContours.size(); i++)
    {
        ...
        /**
         * debug
         * lay tham so de thay vao dieu kien ben duoi
         */
        //cout << i << " " << ratio << " " << area << endl;
...
void DetectObstacle::update(Mat &src){
    ...
    for(int i = 0; i < 4; i++){
        ...
        //imwrite(to_string(i) + ".png", Threshold);
